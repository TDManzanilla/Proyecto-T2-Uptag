                    ...
                    <div class="card card-outline card-info">
                        ...
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            <a href="<?=APP_URL;?>/admin/configuraciones" class="btn btn-secondary">Volver</a>
                                        </div>
                                    </div>
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            <a href="<?=APP_URL;?>/admin/configuraciones/institucion/edit.php?id=<?=$id_config_institucion?>" class="btn btn-success">Editar</a>
                                        </div>
                                    </div>
                                </div>
