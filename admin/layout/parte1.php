            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?=APP_URL;?>/admin/configuraciones/gestion" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?=APP_URL;?>/admin/asignacion" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Carga Curricular</p>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?=APP_URL;?>/admin/docentes/asignacion" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Asignaciones</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link active">
                            <i class="nav-icon fas"><i class="bi bi-person-video2"></i></i>
                            <p>
                                Estudiantes
                                <i class="right fas fa-angle-left"></i>
                            </p>
