            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card card-outline card-success">
                        ...
                        <div class="card-body">
                            <form action="<?=APP_URL;?>/app/controllers/usuarios/edit.php" method="post">
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <a href="<?=APP_URL;?>/admin/usuarios" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Cancelar</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
